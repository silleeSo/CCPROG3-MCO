/** 
 * This class extends abstract class VendingMachine and represents one regular vending machine
 */
public class RegularVM extends VendingMachine{
    /**
     * This constructor creates an instance of RegularVM
     * @param numSlots the number of slots in the regular vending machine
     * @param slotCapacity the capacity of each slot in the regular vending machine
     */
     ...
     * @return String indicating result of purchase attempt
     */
