...
public class View {
    ...
    // makeMySpecVMPurchaseAnItem()
    private Button btnConfirmSpecVMPurchaseAnItem = new Button();
    public Button getBtnConfirmSpecVMPurchaseAnItem() {
        return btnConfirmSpecVMPurchaseAnItem;
    }
    private ArrayList<ImageView> specVMPictures = new ArrayList<ImageView>();
    public ArrayList<ImageView> getSpecVMPictures() {
        return specVMPictures;
    }
    private ArrayList<TextField> specVMQuantities = new ArrayList<TextField>();
    public ArrayList<TextField> getSpecVMQuantities() {
        return specVMQuantities;
    }
    private ArrayList<Text> specVMInfo = new ArrayList<Text>();
    public ArrayList<Text> getSpecVMInfo() {
        return specVMInfo;
    }
    ...
    // makeSpecSlotCreateNewItem()
    private TextField textNameSpecSlotCreateNewItem = new TextField();
    public TextField getTextNameSpecCreateItem() {
        return textNameSpecSlotCreateNewItem;
    }
    private TextField textPriceSpecSlotCreateNewItem = new TextField();
    public TextField getTextPriceSpecCreateItem() {
        return textPriceSpecSlotCreateNewItem;
    }
    private TextField textCaloriesSpecSlotCreateNewItem = new TextField();
    public TextField getTextCaloriesSpecCreateItem() {
        return textCaloriesSpecSlotCreateNewItem;
    }
    private TextField textIsSoldAlone = new TextField();
    public TextField getTextIsSoldAlone() {
        return textIsSoldAlone;
    }
    private TextField textPreparation = new TextField();
    public TextField getTextPreparation() {
        return textPreparation;
    }
    private Button btnSpecSelectItemPicture = new Button();
    public Button getBtnSpecSelectItemPicture() {
        return btnSpecSelectItemPicture;
    }
    private Button btnConfirmSpecCreateNewItem = new Button();
    public Button getBtnConfirmSpecCreateNewItem() {
        return btnConfirmSpecCreateNewItem;
    }
    private Button btnBackSpecCreateNewItem = new Button();
    public Button getBtnBackSpecCreateNewItem() {
        return btnBackSpecCreateNewItem;
    }
    ...
    private Button btnBackPayItem = new Button();
    public Button getBtnBackPayItem() {
        return btnBackPayItem;
    }
    ...
    public Scene makeSpecSlotCreateNewItem() {
        GridPane paneSpecSlotCreateNewItem = new GridPane();

        Image imgSpecSlotCreateNewItem = new Image("file:SlotCreateNewItem.png");
        ImageView viewSpecSlotCreateNewItem = new ImageView(imgSpecSlotCreateNewItem);
        viewSpecSlotCreateNewItem.setFitWidth(500);
        viewSpecSlotCreateNewItem.setPreserveRatio(true);
        ...
        Image imgIsSoldAlone = new Image("file:isSoldAlone.png");
        ImageView viewIsSoldAlone = new ImageView(imgIsSoldAlone);
        viewIsSoldAlone.setFitHeight(50);
        viewIsSoldAlone.setPreserveRatio(true);

        Image imgPreparation = new Image("file:Preparation.png");
        ImageView viewPreparation = new ImageView(imgPreparation);
        viewPreparation.setFitHeight(50);
        viewPreparation.setPreserveRatio(true);

        Image imgSpecSelectItemPicture = new Image("file:SelectItemPicture.png");
        ImageView viewSpecSelectItemPicture = new ImageView(imgSpecSelectItemPicture);
        viewSpecSelectItemPicture.setFitHeight(50);
        viewSpecSelectItemPicture.setPreserveRatio(true);
        btnSpecSelectItemPicture.setPrefSize(370, 50);
        btnSpecSelectItemPicture.setGraphic(viewSpecSelectItemPicture);

        Image imgConfirm = new Image("file:Confirm.png");
        ImageView viewConfirm = new ImageView(imgConfirm);
        viewConfirm.setFitHeight(50);
        viewConfirm.setPreserveRatio(true);
        btnConfirmSpecCreateNewItem.setPrefSize(125, 50);
        btnConfirmSpecCreateNewItem.setGraphic(viewConfirm);

        Image imgBack = new Image("file:Back.png");
        ImageView viewBack = new ImageView(imgBack);
        viewBack.setFitWidth(50);
        viewBack.setPreserveRatio(true);
        btnBackSpecCreateNewItem.setPrefSize(50, 36);
        btnBackSpecCreateNewItem.setGraphic(viewBack);

        textIsSoldAlone.setText("Please enter either \"true\" or \"false\"");

        paneSpecSlotCreateNewItem.add(viewSpecSlotCreateNewItem, 0, 0, 4, 1);
        paneSpecSlotCreateNewItem.add(viewItemName, 0, 1);
        paneSpecSlotCreateNewItem.add(textNameSpecSlotCreateNewItem, 1, 1);
        paneSpecSlotCreateNewItem.add(viewPrice, 0, 2);
        paneSpecSlotCreateNewItem.add(textPriceSpecSlotCreateNewItem, 1, 2);
        paneSpecSlotCreateNewItem.add(viewItemCalories, 0, 3);
        paneSpecSlotCreateNewItem.add(textCaloriesSpecSlotCreateNewItem, 1, 3);
        paneSpecSlotCreateNewItem.add(viewIsSoldAlone, 2, 1);
        paneSpecSlotCreateNewItem.add(textIsSoldAlone, 3, 1);
        paneSpecSlotCreateNewItem.add(viewPreparation, 2, 2);
        paneSpecSlotCreateNewItem.add(textPreparation, 3, 2);
        paneSpecSlotCreateNewItem.add(btnSpecSelectItemPicture, 0, 4, 4, 1);
        paneSpecSlotCreateNewItem.add(btnConfirmSpecCreateNewItem, 0, 5, 4, 1);
        paneSpecSlotCreateNewItem.add(btnBackSpecCreateNewItem, 4, 6);
        paneSpecSlotCreateNewItem.setVgap(50);
        paneSpecSlotCreateNewItem.setHgap(30);
        paneSpecSlotCreateNewItem.setPadding(new Insets(20));
        paneSpecSlotCreateNewItem.setStyle("-fx-background-color: #FFFFFF");
        GridPane.setHalignment(viewSpecSlotCreateNewItem, HPos.CENTER);
        GridPane.setHalignment(btnSpecSelectItemPicture, HPos.CENTER);
        GridPane.setHalignment(btnConfirmSpecCreateNewItem, HPos.CENTER);

        Scene sceneViewSlotCreateNewItem = new Scene(paneSpecSlotCreateNewItem);
        return sceneViewSlotCreateNewItem;
    }
    ...
    public Scene makeMySpecVMPurchaseAnItem() {
        GridPane paneMySpecVMPurchaseAnItem = new GridPane();

        Image imgMySpecVMPurchaseAnItem = new Image("file:MyVMPurchaseAnItem.png");
        ImageView viewMySpecVMPurchaseAnItem = new ImageView(imgMySpecVMPurchaseAnItem);
        viewMySpecVMPurchaseAnItem.setFitWidth(500);
        viewMySpecVMPurchaseAnItem.setPreserveRatio(true);
        ...
        viewConfirm.setFitHeight(50);
        viewConfirm.setPreserveRatio(true);
        btnConfirmSpecVMPurchaseAnItem.setPrefSize(125, 50);
        btnConfirmSpecVMPurchaseAnItem.setGraphic(viewConfirm);
        
        for(int i = 0; i <= 14; i++) {
            specVMPictures.add(new ImageView());
            specVMPictures.get(i).setFitHeight(70);
            specVMPictures.get(i).setPreserveRatio(true);
            specVMPictures.get(i).setVisible(false);
            specVMQuantities.add(new TextField());
            specVMPictures.get(i).setVisible(false);
            specVMInfo.add(new Text());
            specVMQuantities.get(i).setVisible(false);
        }
        
        int noOfSlots = Integer.parseInt(textSpecialVMNoOfSlots.getText());

        paneMySpecVMPurchaseAnItem.add(viewMySpecVMPurchaseAnItem, 0, 0, 5, 1);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(0), 0, 1, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(0), 1, 1);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(0), 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(1), 2, 1, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(1), 3, 1);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(1), 3, 2);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(2), 4, 1, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(2), 5, 1);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(2), 5, 2);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(3), 6, 1, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(3), 7, 1);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(3), 7, 2);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(4), 8, 1, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(4), 9, 1);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(4), 9, 2);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(5), 0, 3, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(5), 1, 3);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(5), 1, 4);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(6), 2, 3, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(6), 3, 3);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(6), 3, 4);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(7), 4, 3, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(7), 5, 3);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(7), 5, 4);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(8), 6, 3, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(8), 7, 3);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(8), 7, 4);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(9), 8, 3, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(9), 9, 3);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(9), 9, 4);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(10), 0, 5, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(10), 1, 5);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(10), 1, 6);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(11), 2, 5, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(11), 3, 5);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(11), 3, 6);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(12), 4, 5, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(12), 5, 5);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(12), 5, 6);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(13), 6, 5, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(13), 7, 5);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(13), 7, 6);
        paneMySpecVMPurchaseAnItem.add(specVMPictures.get(14), 8, 5, 1, 2);
        paneMySpecVMPurchaseAnItem.add(specVMQuantities.get(14), 9, 5);
        paneMySpecVMPurchaseAnItem.add(specVMInfo.get(14), 9, 6);
        paneMySpecVMPurchaseAnItem.add(btnBack, 9, noOfSlots / 5 + 4);
        paneMySpecVMPurchaseAnItem.add(btnConfirmSpecVMPurchaseAnItem, 8, noOfSlots / 5 + 4);

        paneMySpecVMPurchaseAnItem.setVgap(50);
        paneMySpecVMPurchaseAnItem.setHgap(30);
        paneMySpecVMPurchaseAnItem.setPadding(new Insets(20));
        paneMySpecVMPurchaseAnItem.setStyle("-fx-background-color: #FFFFFF");

        for(int i = 0; i <= noOfSlots - 1; i++) {
            specVMPictures.get(i).setVisible(true);
            specVMInfo.get(i).setVisible(true);
            specVMQuantities.get(i).setVisible(true);
        }
        
        Scene sceneMySpecVMPurchaseAnItem = new Scene(paneMySpecVMPurchaseAnItem);
        return sceneMySpecVMPurchaseAnItem;
    }
    ...
    public Scene makePayItem() {
        ...
        viewBack.setFitWidth(50);
        viewBack.setPreserveRatio(true);
        btnBackPayItem.setPrefSize(50, 36);
        btnBackPayItem.setGraphic(viewBack);
        ...
        panePayItem.add(btnBackPayItem, 1, 10);
